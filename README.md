This project is using React and Node, so before getting started you will need to see if Node is installed.
...
2. In a command prompt type `git clone https://github.com/lewing728/meyer-application.git`
